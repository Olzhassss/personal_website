...
<Image src="page_6.jpg" alt="one page from the chapter" caption="First page of the chapter as an example" />
...
<Image src="page_15.jpg" alt="isn't this a real multimodal expression of the visual mode?" classes="mx-auto my-4 max-w-[40%]" />
...
<Image src="a_ghoul.gif" alt="true beauty of Hinami" classes="mx-auto my-4 max-w-[40%]" caption="Hinami Fueguchi and her double kagune" />
...
<div class="w-full mb-8 overflow-auto whitespace-nowrap">
    <Image src="characters/kaneki1.jpg" alt="Ken Kaneki" classes="h-[220px] inline-block" caption="Ken Kaneki in the beginning" />
    <Image src="characters/kaneki2.png" alt="Ken Kaneki" classes="h-[220px] inline-block" caption="Ken Kaneki after surviving a torture" />
    <Image src="characters/kaneki3.png" alt="Ken Kaneki" classes="h-[220px] inline-block" caption="Haise Sasaki" />
    <Image src="characters/kaneki4.jpg" alt="Ken Kaneki" classes="h-[220px] inline-block" caption="Ken Kaneki after this chapter" />
...
<div class="w-full flex justify-center mb-8">
    ...
    <Image src="characters/tsukiyama2.jpg" alt="Shu Tsukiyama" classes="h-[300px]" caption="Sad Shu" />
    <Image src="characters/kanae1.webp" alt="Karren von Rosewald" classes="h-[300px]" caption="Normal Kanae (Karren)" />
    <Image src="characters/kanae2.webp" alt="Karren von Rosewald" classes="h-[300px]" caption="Kanae after surviving a torture" />
</div>
...
<div class="flex justify-center mb-8">
    <Image src="page_4.jpg" alt="page 4" classes="w-[40%]" />
    <Image src="page_5.jpg" alt="page 5" classes="w-[40%]" />
</div>
...
<div class="overflow-x-auto whitespace-nowrap mb-8">
    ...
    <Image src="page_8_edited.jpg" alt="page 8 edited" classes="mx-[10%] inline-block w-[40%]" />
    <Image src="page_10_edited.jpg" alt="page 10 edited" classes="mx-[10%] inline-block w-[40%]" />
...
<Image src="page_11.jpg" alt="page 11" />
...
<Image src="page_12_edited.jpg" alt="page 12 edited" classes="float-left mr-4 w-[25%]" />
