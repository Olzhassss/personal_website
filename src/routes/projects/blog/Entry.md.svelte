...
In this blog, I am going to look at a famous manga - Tokyo Ghoul by Sui Ishida - from a perspective of rhetorical and design analysis. I will be specifically focusing on chapter 53 of Tokyo Ghoul: Re (the sequel aka part 2) because the entirety of this story counts 323 chapters of content that is impossible neither to comprehend nor to explain in details. But let's first explore what manga is.

<p class="text-base">
    <em>Side note:</em> I will be using English localization available online. English localization is done by amateurs. I could not find the original version of the pages, therefore I can only analyze text as is edited by the localizators. Unlike them, the original text likely looks (and feels) more natural and expressive.
</p>
<p class="text-base">
    <em>Side note 2:</em> Sui Ishida is the author of the story, but, in fact, manga is made by him and his assistant artists. I will address Sui as the single author for simplicity.
</p>

## What’s manga? Genre conventions and design elements

<Image src="blog/page_6.jpg" alt="one page from the chapter" caption="First page of the chapter as an example" />

Manga, to put it simply, is a Japanese version of American comic books. It is a form of entertainment, writing and visual art. If to look at it from the genre perspective, manga is obviously a subgenre of the comic genre. Here are some genre conventions to distinguish manga from other genres:

+ As a form of comic, manga is built on frames – its fundamental design elements.
...
## Manga as a multimodal text

It’s evident from the preview page and pictures on this webpage that manga is a medium of the visual mode. What’s more, manga basically imbues the visual mode with the other 4 (as described in chapter 1 of Writer/Designer) – aural, gestural, spatial and linguistic. As a person with personal experience of creating manga, I would argue that creating manga (like comic books) is actually *the* art of embodying of all these modes of communication within or through one – plain 2D A4/A5 black-white visual. I will be discussing all of this in details later, but just look at the page below if you feel like I’m exaggerating:

<Image src="blog/page_15.jpg" alt="isn't this a real multimodal expression of the visual mode?" classes="mx-auto my-4 max-w-[40%]" />


## Background for the chapter and Context (this one is very long)

It’s truly confusing to read or analyze the chapter without the background, so I’ll give a brief and generalized explanation of the world setting and the characters.

In this world there’re humans and ghouls. Ghouls are practically monster-humans that feed on flesh (particularly, human flesh). They have much more of so-called “RC cells” that can be produced and excited to work like muscles and transform into different genetically-defined shapes outside of the body. Those muscles are called “kagune”. When not using kagune, ghouls look exactly like humans; but in arousal of RC cells ghouls’ eyes turn black and red (see the gif below). Ghouls also can regenerate and, sometimes, grow entire body shell (mutated kagune) using these cells (see **Eto**).

<Image src="blog/a_ghoul.gif" alt="true beauty of Hinami" classes="mx-auto my-4 max-w-[40%]" caption="Hinami Fueguchi and her double kagune" />

There is also the CCG – a non-governmental organization that is “the ministry of dealing with ghouls”. It controls squads of specialists-investigators (wearing white suits) that carry out extermination of ghouls. These specialists wield artificially extracted and modified kagune (called “quinque”) to be on par with ghouls. There’s a *special* squad “Quinx” of investigators that were implanted with RC cell control system and quinque to become human-ghouls under the CCG. So far the CCG is at war with ghouls. Now, to the characters.

<br>
<div class="w-full mb-8 overflow-auto whitespace-nowrap">
    <Image src="blog/characters/kaneki1.jpg" alt="Ken Kaneki" classes="h-[220px] inline-block" caption="Ken Kaneki in the beginning" />
    <Image src="blog/characters/kaneki2.png" alt="Ken Kaneki" classes="h-[220px] inline-block" caption="Ken Kaneki after surviving a torture" />
    <Image src="blog/characters/kaneki3.png" alt="Ken Kaneki" classes="h-[220px] inline-block" caption="Haise Sasaki" />
    <Image src="blog/characters/kaneki4.jpg" alt="Ken Kaneki" classes="h-[220px] inline-block" caption="Ken Kaneki after this chapter" />
    <Image src="blog/characters/kaneki5.jpg" alt="Ken Kaneki" classes="h-[220px] inline-block" caption="Ken Kaneki in the end" />
</div>
...
<div class="w-full flex justify-center mb-8">
    <Image src="blog/characters/tsukiyama1.webp" alt="Shu Tsukiyama" classes="h-[300px]" caption="Young Shu" />
    <Image src="blog/characters/tsukiyama2.jpg" alt="Shu Tsukiyama" classes="h-[300px]" caption="Sad Shu" />
    <Image src="blog/characters/kanae1.webp" alt="Karren von Rosewald" classes="h-[300px]" caption="Normal Kanae (Karren)" />
    <Image src="blog/characters/kanae2.webp" alt="Karren von Rosewald" classes="h-[300px]" caption="Kanae after surviving a torture" />
</div>
...
<div class="w-full flex justify-center mb-8">
    <Image src="blog/characters/eto1.png" alt="Eto Yoshimura" classes="h-[300px]" caption="Eto Yoshimura" />
    <Image src="blog/characters/eto2.png" alt="Eto in the shell" classes="h-[300px]" caption="Eto in the shell" />
</div>
...
<div class="w-full flex justify-center mb-8">
    <Image src="blog/characters/ui1.jpg" alt="Koori Ui" classes="h-[300px]" caption="Koori Ui" />
    <Image src="blog/characters/ihei1.webp" alt="Hairu Ihei" classes="h-[300px]" caption="Hairu Ihei" />
</div>
...
The summary as pre-iconography:

1.	Eto appeared in her shell and dealt a surprise attack on Haise.
2.	She taunted him and then incited Kanae to continue the fight. Kanae was with stitched eyes and mouth.
3.	Meanwhile, Koori approached the place where Hairu was supposed to be and started obsessively naming metro stations. Background showed the stations and Hairu.
4.	There was a frame with Koori and Hairu strolling down a street in the evening - Koori walking and Hairu skipping.
5.	Next was a large frame of Koori in silence, then smaller frame of his hand squeezing the quinque.
6.	He found and asked a survived investigator of the fight between Hairu’s squad and servants.
7.	Scene changes to Haise. He was being beat up by Kanae while Eto was enjoying the scene.
...
Naturally, there is a lot of implied meaning that the audience would easily understand without any explanation. For the sake of structure though, I consider it separately as a part of iconographical analysis. One last step before the analysis - understanding the purpose of this text.

## What’s the purpose of this text?

In this chapter, Sui Ishida describes three different events that happen at the same time – Shirazu vs ghoul, Koori’s investigation and Kanae vs Haise. Most attention is given to Haise’s subconscious episode, and some to Koori. Given the context and summary, author mainly intended to thrust the story of Koori, Haise and Kanae. Audience – the readers of this manga – were expected to become more aware of these characters, feel more of their pain (actually, there’s just more and more pain to feel in this tragedy up until the end), be intrigued and influenced by characters’ explicit and implicit feelings. For example, readers are shown Kanae, at last, openly expressing her obsession and devotion to Shu through her (partly driven by Eto’s torture) vigorous impulsiveness and hate. Koori always looked like emotionless but, apparently, actually had affection and felt pain after found Hairu dead. Ken Kaneki reveals to himself that the mother he said to deeply care for actually abused him, but he used to block this memories. To make the effect, the visual narration must be profoundly expressive but not overwhelming. Furthermore, readers were supposed to understand that Ken’s true intentions in the final battle of Tokyo Ghoul was to die, heroically. Now, with Haise near death, Ken wants to try dying heroically again, and Haise drearily accepts the fact that, after all, he was just “a pleasant dream” covering multiple trauma; thus Haise Sasaki becomes Ken Kaneki again. Aside from surprising the readers, the author wanted readers to feel: Haise, a distinct personality, finally giving up oneself – being merged and, therefore, killed; and Ken, ultimately, returning consciousness with entirety of his dire past but in robust conviction. So, was the author effective in using iconography, semiotics and form in fulfilling this purpose?

## Iconographical and form analysis with semiotics

<div class="flex justify-center mb-8">
    <Image src="blog/page_4.jpg" alt="page 4" classes="w-[40%]" />
    <Image src="blog/page_5.jpg" alt="page 5" classes="w-[40%]" />
</div>
...
<div class="overflow-x-auto whitespace-nowrap mb-8">
    <Image src="blog/page_7_edited.jpg" alt="page 7 edited" classes="mx-[10%] inline-block w-[80%]" />
    <Image src="blog/page_8_edited.jpg" alt="page 8 edited" classes="mx-[10%] inline-block w-[40%]" />
    <Image src="blog/page_10_edited.jpg" alt="page 10 edited" classes="mx-[10%] inline-block w-[40%]" />
    <Image src="blog/page_13_edited.jpg" alt="page 13 edited" classes="mx-[10%] inline-block w-[40%]" />
    <Image src="blog/page_15_edited.jpg" alt="page 15 edited" classes="mx-[10%] inline-block w-[40%]" />
...
<div class="w-full h-max flex items-center">
    ...
    <Image src="blog/page_15_cropped.jpg" alt="page 15 cropped" classes="mx-4 w-[20%] shrink-0" />
</div>


### Symbolic and implied meaning

#### Koori and Hairu

<Image src="blog/page_11.jpg" alt="page 11" />

When Koori started naming stations (which is actually a small game in Japanese culture), he tried to distract himself from the surroundings and intrusive thought (of Hairu’s death that he was ready but really not ready for). He tried to substitute one intrusive thought with the other – the author expressed this as an enormous amount of text in the frames with one slipping frame of Hairu’s face, followed by another “distorted” one. In addition to appealing to the cultural common knowledge (the game), this page effectively demonstrates the character’s internal state.

Koori, however, was unsuccessful, which is implied by the usage of a large detailed flashback frame of him and Hairu. Given that readers know about Hairu’s death, seeing a serene picture of their joyful walk (joyfulness is signified by Hairu – she is skipping and naming a prominent Japanese multinational food processing company that makes sweets) might bring sorrow to them, since they can imagine or feel how Koori will mourn for such memories with Hairu.

<Image src="blog/page_12_edited.jpg" alt="page 12 edited" classes="float-left mr-4 w-[25%]" />
...
<Image src="blog/Kaneki_vs_Yamori.webp" alt="Kaneki escaping the torturer" classes="float-right ml-4 w-[20%]" caption="Kaneki escaping the torturer" />
...
<div class="overflow-x-auto whitespace-nowrap mb-8">
    <Image src="blog/page_17.jpg" classes="mx-[10%] inline-block w-[40%]" />
    <Image src="blog/page_18.jpg" classes="mx-[10%] inline-block w-[80%]" />
    <Image src="blog/page_19.jpg" classes="mx-[10%] inline-block w-[40%]" />
    <Image src="blog/page_20.jpg" classes="mx-[10%] inline-block w-[40%]" />
    <div class="mx-[10%] inline-block"></div>
</div>
