...
function Q(t) {
	...
	for (let l = 0; l < n.length; l++) {
		const u = n[l].claim_order,
			a = (r > 0 && n[e[r]].claim_order <= u ? r + 1 : W(1, r, (g) => n[e[g]].claim_order, u)) - 1;
		i[l] = e[a] + 1;
		const f = a + 1;
...
function dt(t, n, e) {
	v && !e ? R(t, n) : (n.parentNode !== t || n.nextSibling != e) && t.insertBefore(n, e || null);
}
function U(t) {
...
function F() {
	...
	do {
		...
		for (m(null), h.length = 0, d = 0; k.length; ) k.pop()();
